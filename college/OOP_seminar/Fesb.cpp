...
BEGIN_MESSAGE_MAP(CFesbApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CFesbApp::OnAppAbout)
...
CFesbApp::CFesbApp()
{
	...
	SetAppID(_T("Fesb.AppID.NoVersion"));
...
// CFesbApp customization load/save methods

void CFesbApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CFesbApp::LoadCustomState()
{
}

void CFesbApp::SaveCustomState()
{
}
